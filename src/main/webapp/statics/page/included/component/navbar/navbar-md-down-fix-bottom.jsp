...
<nav class="navbar navbar-md-down-fix-bottom p-t-1-5em p-b-1em" role="navigation"
    ...
    <div class="navbar-brand col-md-2 hidden-md-down m-r-6-5em m-l-2em">
        <img ng-if="${pageComponent.jsonVariableName}.navbarBrand&&${pageComponent.jsonVariableName}.navbarBrand.type&&${pageComponent.jsonVariableName}.navbarBrand.type==='image'"
             ng-src="{{${pageComponent.jsonVariableName}.navbarBrand.value}}" class="img-responsive img-ico-larger m-l-5em">
