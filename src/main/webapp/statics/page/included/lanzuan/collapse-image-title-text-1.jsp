...
<div class="row  m-l-r-0 m-t-2-4em m-b-1-6em md-up-p-l-r-4em " ng-init="get${pageComponent.variableFirstUpper}();_active=0">
    <div class="col-xs-12 col-md-9 p-a-0 m-a-0">
                    <span class="col-xs-12 col-md-4 col-lg-3 col-xl-2 p-r-0">
                        <h4 class="md-down-no-padding-left large-180" >{{${pageComponent.jsonVariableName}.text}}</h4>
                    </span>
                    <span class="col-xs-12 col-md-8 col-lg-9 col-xl-10 text-left m-a-0">

                        <span ng-repeat="block in ${pageComponent.jsonVariableName}.items">
                            ...
                            <span ng-if="$index!==${pageComponent.jsonVariableName}.items.length-1" class="divider hidden-sm-down"></span>
                        </span>
                </span>
    </div>

</div>
<div class="row m-l-r-0 md-up-p-l-r-4em m-b-2em" ng-repeat="block in ${pageComponent.jsonVariableName}.items"
