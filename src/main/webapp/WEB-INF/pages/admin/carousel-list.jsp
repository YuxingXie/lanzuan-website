...
<div class="container-fluid" ng-controller="AdminController" ng-init="getAllCarousels()">
    <div class="row">
        <div class="alert alert-info">
            <h5 class="text-center">应用轮播方案</h5>
            <a class="fa fa-reply btn btn-primary btn-sm white-link" href="${path}/admin/page_component/edit/${pageComponentId}">返回轮播图编辑页</a>
        </div>
        ...
        <div class="col-xs-12">
            <div>
                <div class="row p-a-0 m-a-0 large-180 bg-light-grey">
                    <div class="col-xs-2">方案名称</div>
                    <div class="col-xs-3">轮播项</div>
                    <div class="col-xs-4">可用状态</div>
                    <div class="col-xs-2">禁用/启用</div>
                </div>

                    <div class="row p-a-0 m-a-0 solid-silver-border-top solid-silver-border-bottom hover-bg-color-grey" ng-repeat="carousel in carousels">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-3">
                            <span class="fa fa-2x hover-cursor-hand" ng-click="changeEnabledStatus(carousel)"
