    ...
    <div class="container-fluid  p-a-0 m-a-0" ng-controller="AdminController" ng-init="initAdmin()">
        ...
        <div class="row p-t-2em m-a-0">
            <div ng-controller="HomeController">
                <div class="col-xs-12 alert alert-info" >上传一个资源</div>
                <div class="col-xs-12" >
                    <form autocomplete="off" method="post" accept-charset="UTF-8" enctype="multipart/form-data"
                          role="form" action="/admin/resource/upload">
                        <fieldset>
                            <div class="form-group input-group">
                                <label class="fa fa-user input-group-addon">资源类型</label>
                        ...
                        <fieldset>
                            <div class="form-group input-group">
                                <label class="fa fa-user input-group-addon">本地资源</label>
