...
<%--<c:if test="${not empty component}">--%>
    ...
    <%--$scope.save${component.varU}=function(){--%>
        <%--&lt;%&ndash;console.log(JSON.stringify($scope.${component.var}));&ndash;%&gt;--%>
    ...
    <%--$scope.insert${component.varU}Item= function (index) {--%>
        ...
        <%--}--%>
        <%--var item={};--%>
        <%--&lt;%&ndash;var item=$scope.${component.var}.items.shift();&ndash;%&gt;--%>
        <%--&lt;%&ndash;console.log(JSON.stringify(item))&ndash;%&gt;--%>
        <%--&lt;%&ndash;$scope.${component.var}.items.splice(0,0,item,item);&ndash;%&gt;--%>
        <%--&lt;%&ndash;return;&ndash;%&gt;--%>
