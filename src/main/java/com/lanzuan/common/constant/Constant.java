...
public class Constant {
    ...
    public static final String ICO_DIR="/statics/image/upload/icon";
    public static final String IMAGE_TEXT_BLOCK_GROUP_ITEM_IMAGE_DIR ="/statics/image/upload/lanzuan/280-180";
    ...
    public static final String DOCUMENT_DIR="/statics/document";
    public static final String DOCUMENT_FILE_DIR="/statics/document/file";
    public static final String DOCUMENT_IMAGE_DIR="/statics/document/image";
    public static final String DOCUMENT_VIDEO_DIR="/statics/document/video";
