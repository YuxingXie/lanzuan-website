...
//        fields.add("articles");
        ...
        if (sortLinkGroup ==null|| sortLinkGroup.getItems()==null &&sortLinkGroup.getItems().size()==0){
            ...
            article1.setContent("<div class=\"row\">\n" +
                    ...
                    "\n" +
                    "\n" +
                    "                    <img type=\"gif\" src=\"/statics/image/lanzuan/news/001.gif\" class=\"img-responsive m-t-10 margin-bottom-10\"  />\n" +
                    "                2016\n" +
                    "                年3月29日，蓝钻公司2016年新媒体云服务商交流大会在湖南省长沙市宁乡县湘都生态农庄举行，\n" +
                    "                这是蓝钻公司召集全国各地服务商召开的一场别开生面的交流会议。\n" +
                    "                <img type=\"jpeg\" src=\"/statics/image/lanzuan/news/002\" class=\"img-responsive m-t-10 margin-bottom-10\"  />\n" +
                    "\n" +
                    "                传统媒体与新兴媒体的融合发展\n" +
                    "                毫无疑问\n" +
                    "\n" +
                    ...
                    "                希望在媒体融合的道路上取得更大的发展。\n" +
                    "                <img type=\"jpeg\" src=\"/statics/image/lanzuan/news/003\" class=\"img-responsive m-t-10 margin-bottom-10\"  />\n" +
                    "\n" +
                    "                移动互联技术飞速发展的时代，智慧城市的建设成为转变城市发展方式、\n" +
                    "                提升城市发展质量的重要方略。此次会议，蓝钻公司提出以蓝钻云·WiFi作为流量入口助力宁乡县智慧城市的建设，并从宏观立场、业务模式、\n" +
                    "                技术运营等角度提出了发展建议。\n" +
                    "                    <img src=\"/statics/image/lanzuan/news/6401\" class=\"img-responsive m-t-10 margin-bottom-10\"  />\n" +
                    ...
                    "\n" +
                    "\n" +
                    "                <img src=\"/statics/image/lanzuan/news/6403\" class=\"img-responsive m-t-10 margin-bottom-10\"  />\n" +
                    "                    同时，建立基于数据层的数据中心，以数据为支撑建立业务模块，并重视后续用户需求，对应定向推广，\n" +
                    "                    延伸业务发展方向，创造更多的发展空间。\n" +
                    "\n" +
                    "                <img src=\"/statics/image/lanzuan/news/6404\" class=\"img-responsive m-t-10 margin-bottom-10\"  />\n" +
                    "\n" +
                    "\n" +
                    "\n" +
                    "\n" +
                    "                会上，针对蓝钻云·WiFi的发展问题，不少服务商伙伴提出了中肯的建议，徐总等人认真倾听了大家的意见，并承诺在以后的工作中逐渐落实并改善。\n" +
                    "                    <img src=\"/statics/image/lanzuan/news/6402\" class=\"img-responsive m-t-10 margin-bottom-10\"  />\n" +
                    "\n" +
